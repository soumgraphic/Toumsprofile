...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    private ActivityMainBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            , (dev.soumgraphic.com.toumsprofile.databinding.ContentMainBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeContent((dev.soumgraphic.com.toumsprofile.databinding.ContentMainBinding) object, fieldId);
            case 1 :
                return onChangeUser((dev.soumgraphic.com.toumsprofile.model.User) object, fieldId);
        }
        return false;
    }
    private boolean onChangeContent(dev.soumgraphic.com.toumsprofile.databinding.ContentMainBinding Content, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
